                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="{{ route('update.blog') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" name="blog_category_id"
                                            ...
                                            <option selected="">Select Blog Category Name</option>
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}"
                                                    {{ $category->id == $blogs->blog_category_id ? 'selected' : '' }}>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="blog_tags" value="{{ $blogs->blog_tags }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg"
                                            src="{{ !empty($blogs->blog_image) ? url($blogs->blog_image) : url('upload/no_image.jpg') }}"
                                            alt="Card image cap">
                                    </div>
                                </div>
