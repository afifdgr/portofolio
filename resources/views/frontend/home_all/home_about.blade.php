        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <ul class="about__icons__wrap">
                    <li>
                        <img class="light" src="{{ asset('assets/frontend/img/icons/xd_light.png') }}" alt="XD">
                    ...
                    <li>
                        <img class="light" src="{{ asset('assets/frontend/img/icons/skeatch_light.png') }}"
                            alt="Skeatch">
                        <img class="dark" src="{{ asset('assets/frontend/img/icons/skeatch.png') }}" alt="Skeatch">
                    </li>
                    <li>
                    ...
                    <li>
                        <img class="light" src="{{ asset('assets/frontend/img/icons/hotjar_light.png') }}"
                            alt="Hotjar">
                        <img class="dark" src="{{ asset('assets/frontend/img/icons/hotjar.png') }}" alt="Hotjar">
                    </li>
                    <li>
                        <img class="light" src="{{ asset('assets/frontend/img/icons/invision_light.png') }}"
                            alt="Invision">
                        <img class="dark" src="{{ asset('assets/frontend/img/icons/invision.png') }}" alt="Invision">
                    </li>
                    <li>
                    ...
                    <li>
                        <img class="light" src="{{ asset('assets/frontend/img/icons/figma_light.png') }}"
                            alt="Figma">
                        <img class="dark" src="{{ asset('assets/frontend/img/icons/figma.png') }}" alt="Figma">
                    </li>
                </ul>
            </div>
            <div class="col-lg-6">
